    ...
    content: {
        marketing: {
            ...
            quiz: [
                ...
                { question: "Pelajaran utama dari kasus Netflix 'Finding the Future by Abandoning the Past' adalah...", options: ["Perusahaan harus mempertahankan layanan lama selama mungkin", "Kunci sukses hanya pada konten orisinil, bukan distribusi", "Perusahaan harus berani meninggalkan cara lama demi masa depan agar tidak tertinggal", "Fokus utama harus pada pengiriman fisik DVD daripada streaming"], answer: 2, xp: 5 },
                { question: "Pandangan 'Sense-and-Respond' yang memulai perencanaan dari kebutuhan pelanggan disebut...", options: ["Supply Chain", "Demand Chain", "Value Chain", "Logistic Chain"], answer: 1, xp: 5 },
                { question: "Mitra dalam Value Delivery Network yang menyediakan bahan mentah, komponen, dan keuangan disebut...", options: ["Downstream Partners", "Upstream Partners", "Retailers", "Intermediaries"], answer: 1, xp: 5 },
                { question: "Apa fungsi utama perantara (Intermediaries) terkait efisiensi ekonomi?", options: ["Meningkatkan biaya produk", "Mengurangi jumlah kontak transaksi antara produsen dan konsumen", "Memperpanjang waktu pengiriman", "Menghilangkan peran produsen"], answer: 1, xp: 5 },
                { question: "Fungsi anggota saluran: Membentuk dan menyesuaikan penawaran dengan kebutuhan pembeli (perakitan/pengemasan) disebut...", options: ["Contact", "Matching", "Negotiation", "Promotion"], answer: 1, xp: 5 },
                { question: "Saluran pemasaran yang TIDAK memiliki perantara (Produsen -> Konsumen) disebut...", options: ["Indirect Marketing Channel", "Direct Marketing Channel", "Hybrid Channel", "Vertical Channel"], answer: 1, xp: 5 },
                { question: "Konflik yang terjadi antar perusahaan pada tingkat saluran yang sama (misal: Dealer A vs Dealer B) disebut...", options: ["Vertical Conflict", "Horizontal Conflict", "System Conflict", "Multi-channel Conflict"], answer: 1, xp: 5 },
                { question: "Konflik antara McDonald's pusat dengan pemegang franchise terkait standar pelayanan adalah contoh...", options: ["Horizontal Conflict", "Vertical Conflict", "Lateral Conflict", "External Conflict"], answer: 1, xp: 5 },
                { question: "Bentuk VMS di mana produksi dan distribusi digabungkan di bawah kepemilikan tunggal (Single Ownership) adalah...", options: ["Corporate VMS", "Contractual VMS", "Administered VMS", "Conventional VMS"], answer: 0, xp: 5 },
                { question: "Franchise Organization (Waralaba) adalah contoh paling umum dari...", options: ["Corporate VMS", "Contractual VMS", "Administered VMS", "Horizontal Marketing System"], answer: 1, xp: 5 },
                { question: "VMS di mana kepemimpinan diasumsikan melalui ukuran dan kekuatan dominasi salah satu anggota (seperti Walmart/Apple) disebut...", options: ["Corporate VMS", "Contractual VMS", "Administered VMS", "Conventional Channel"], answer: 2, xp: 5 },
                { question: "Ketika dua perusahaan di level yang sama bergabung untuk peluang baru (Contoh: Starbucks di dalam Target), disebut...", options: ["Vertical Marketing System", "Horizontal Marketing System", "Multichannel System", "Disintermediation"], answer: 1, xp: 5 },
                { question: "Fenomena tergesernya iTunes oleh Spotify atau bangkrutnya Toys'R'Us karena e-commerce disebut...", options: ["Intermediation", "Disintermediation", "Reintermediation", "Integration"], answer: 1, xp: 5 },
                { question: "Strategi distribusi untuk 'Convenience Products' (sabun, permen) yang menyetok di sebanyak mungkin outlet adalah...", options: ["Exclusive Distribution", "Selective Distribution", "Intensive Distribution", "Niche Distribution"], answer: 2, xp: 5 },
                { question: "Strategi distribusi untuk 'Luxury Goods' (Rolex, Mobil Mewah) yang memberikan hak pada jumlah dealer sangat terbatas adalah...", options: ["Exclusive Distribution", "Selective Distribution", "Intensive Distribution", "Mass Distribution"], answer: 0, xp: 5 },
                { question: "Strategi distribusi di antara intensif dan eksklusif (contoh: TV, Furniture, Nike) disebut...", options: ["Inclusive Distribution", "Selective Distribution", "Intensive Distribution", "Exclusive Distribution"], answer: 1, xp: 5 },
                { question: "Hukum: Produsen menjual merek kuat HANYA jika dealer mau mengambil merek lain yang kurang laku (Full-line forcing) disebut...", options: ["Exclusive Dealing", "Tying Agreements", "Exclusive Territorial", "Dumping"], answer: 1, xp: 5 },
                { question: "Tujuan utama Logistik Pemasaran adalah...", options: ["Biaya termurah tanpa peduli layanan", "Layanan terbaik tanpa peduli biaya", "Level layanan target dengan biaya seminimal mungkin", "Menghapus semua gudang"], answer: 2, xp: 5 },
                { question: "Menggunakan penyedia jasa luar (FedEx, DHL) untuk mengurus logistik disebut...", options: ["In-house Logistics", "Third-Party Logistics (3PL)", "Cross-Docking", "Multimodal"], answer: 1, xp: 5 },
                { question: "Kasus Sociolla menggunakan strategi integrasi fisik dan digital yang disebut...", options: ["Direct Marketing", "Omnichannel Retailing", "Single Channel", "Traditional Retail"], answer: 1, xp: 5 },
                { question: "Dalam Supply Chain, pandangan tradisional 'Make-and-Sell' berfokus pada...", options: ["Kebutuhan pelanggan", "Bahan baku, input produktif, dan kapasitas pabrik", "Pemasaran digital", "Layanan purna jual"], answer: 1, xp: 5 },
                { question: "Dalam Desain Saluran, langkah pertama adalah...", options: ["Menetapkan Tujuan", "Menganalisis Kebutuhan Konsumen", "Evaluasi Alternatif", "Memilih Anggota"], answer: 1, xp: 5 },
                // MODUL 2: IMC STRATEGY (14 questions)
                { question: "Apa kunci sukses komunikasi Burger King di tengah kampanye yang 'aneh'?", options: ["Anggaran tak terbatas", "Konsistensi posisi 'Home of the Whopper' & diferensiasi 'Flame-Grilled'", "Selalu menggunakan selebriti", "Meniru McDonald's"], answer: 1, xp: 5 },
                { question: "Alat promosi yang memiliki jangkauan luas, bisa diulang, namun bersifat satu arah (monolog) adalah...", options: ["Personal Selling", "Advertising", "Sales Promotion", "Direct Marketing"], answer: 1, xp: 5 },
                { question: "Alat promosi berupa insentif jangka pendek (diskon/kupon) untuk mendorong pembelian segera adalah...", options: ["Advertising", "Public Relations", "Sales Promotion", "Personal Selling"], answer: 2, xp: 5 },
                { question: "Alat promosi paling mahal per kontak namun paling efektif membangun preferensi dan hubungan adalah...", options: ["Advertising", "Sales Promotion", "Personal Selling", "Public Relations"], answer: 2, xp: 5 },
                { question: "Definisi IMC (Integrated Marketing Communications) menekankan pesan yang...", options: ["Lucu, Viral, Singkat", "Jelas, Konsisten, dan Menarik (Clear, Consistent, Compelling)", "Teknis, Detail, Ilmiah", "Murah, Cepat, Efektif"], answer: 1, xp: 5 },
                { question: "Tahapan model AIDA dalam merancang pesan adalah...", options: ["Awareness, Interest, Desire, Action", "Attention, Interest, Desire, Action", "Action, Interest, Desire, Awareness", "Attention, Information, Decision, Action"], answer: 1, xp: 5 },
                { question: "Metode anggaran promosi yang paling logis (berdasarkan tujuan & tugas) adalah...", options: ["Affordable Method", "Percentage-of-Sales Method", "Competitive-Parity Method", "Objective-and-Task Method"], answer: 3, xp: 5 },
                { question: "Metode anggaran yang salah logika karena memandang penjualan sebagai penyebab promosi (bukan hasil) adalah...", options: ["Affordable Method", "Percentage-of-Sales Method", "Competitive-Parity Method", "Objective-and-Task Method"], answer: 1, xp: 5 },
                { question: "Strategi 'Push Strategy' dilakukan dengan cara...", options: ["Produsen mempromosikan langsung ke konsumen akhir", "Produsen mendorong produk melalui saluran (grosir/ritel) agar mereka menjualnya", "Konsumen meminta barang ke pengecer", "Mengandalkan word-of-mouth"], answer: 1, xp: 5 },
                { question: "Strategi 'Pull Strategy' dilakukan dengan cara...", options: ["Produsen memberikan insentif ke dealer", "Produsen mempromosikan langsung ke konsumen akhir agar mereka meminta barang ke pengecer", "Salesman mendatangi rumah konsumen", "Meningkatkan margin keuntungan pengecer"], answer: 1, xp: 5 },
                { question: "Praktik ilegal 'Bait-and-Switch' adalah...", options: ["Diskon cuci gudang", "Memancing dengan harga murah, bilang stok habis, paksa beli barang mahal", "Memberikan sampel gratis", "Menjual barang bundle"], answer: 1, xp: 5 },
                { question: "Kampanye Tokopedia 'Mulai Aja Dulu' memposisikan brand sebagai...", options: ["Toko termurah", "Enabler (Pemberdaya) mimpi", "Aplikasi tercanggih", "Logistik tercepat"], answer: 1, xp: 5 },
                { question: "Dalam 6 Tahap Kesiapan Pembeli, tahapan setelah 'Knowledge' adalah...", options: ["Purchase", "Liking", "Preference", "Conviction"], answer: 1, xp: 5 },
                { question: "Daya tarik pesan (Message Appeal) yang membangkitkan emosi takut/cinta/humor adalah...", options: ["Rational Appeal", "Emotional Appeal", "Moral Appeal", "Social Appeal"], answer: 1, xp: 5 },
                // MODUL 3: COMPETITIVE ADVANTAGE (15 questions)
                { question: "Filosofi Nordstrom fokus pada...", options: ["Harga Termurah", "Diferensiasi Pelayanan Ekstrem", "Teknologi Canggih", "Lokasi Terbanyak"], answer: 1, xp: 5 },
                { question: "Identifikasi pesaing 'Market View' lebih baik daripada 'Industry View' karena...", options: ["Lebih mudah risetnya", "Mencegah Marketing Myopia (melihat pemuas kebutuhan yang sama)", "Hanya melihat produk yang identik", "Fokus pada proses produksi"], answer: 1, xp: 5 },
                { question: "Alat analisis untuk menentukan manfaat yang dihargai pelanggan & peringkat performa vs pesaing adalah...", options: ["SWOT", "Customer Value Analysis", "BCG Matrix", "Porter 5 Forces"], answer: 1, xp: 5 },
                { question: "Strategi 'Blue Ocean' menyarankan untuk...", options: ["Bertarung di pasar padat (Red Ocean)", "Mencari ruang pasar tanpa pesaing (uncontested) dan menciptakan permintaan baru", "Meniru pemimpin pasar", "Menurunkan harga serendah mungkin"], answer: 1, xp: 5 },
                { question: "Strategi Porter: Menekan biaya produksi terendah untuk harga murah (Contoh: AirAsia/Walmart) adalah...", options: ["Differentiation", "Overall Cost Leadership", "Focus", "Middle-of-the-Roaders"], answer: 1, xp: 5 },
                { question: "Strategi Porter: Menciptakan produk unik/superior (Contoh: Apple) adalah...", options: ["Differentiation", "Overall Cost Leadership", "Focus", "Middle-of-the-Roaders"], answer: 0, xp: 5 },
                { question: "Strategi Porter: Fokus pada segmen sempit/wilayah tertentu (Contoh: Ritz-Carlton) adalah...", options: ["Differentiation", "Overall Cost Leadership", "Focus", "Middle-of-the-Roaders"], answer: 2, xp: 5 },
                { question: "Perusahaan yang gagal karena mencoba jadi segalanya (tidak termurah, tidak terunik) disebut Porter sebagai...", options: ["Market Leader", "Middle-of-the-Roaders", "Market Nicher", "Challenger"], answer: 1, xp: 5 },
                { question: "Strategi Market Leader 'Expand Total Market' meliputi...", options: ["Lower Price, Lower Cost", "New Users, New Uses, More Usage", "Imitate, Adapt, Cloning", "Frontal Attack, Flank Attack"], answer: 1, xp: 5 },
                { question: "Perusahaan Runner-up yang agresif menyerang pemimpin pasar disebut...", options: ["Market Leader", "Market Challenger", "Market Follower", "Market Nicher"], answer: 1, xp: 5 },
                { question: "Perusahaan Runner-up yang main aman dan meniru pemimpin untuk profit stabil disebut...", options: ["Market Challenger", "Market Follower", "Market Nicher", "Market Leader"], answer: 1, xp: 5 },
                { question: "Kunci sukses Market Nicher (Pencari Celah) adalah...", options: ["Volume tinggi", "Spesialisasi & High Margin", "Harga murah", "Distribusi massal"], answer: 1, xp: 5 },
                { question: "Orientasi perusahaan terbaik (Market-Centered) menyeimbangkan fokus pada...", options: ["Produk & Penjualan", "Pelanggan & Pesaing", "Biaya & Profit", "Lokal & Global"], answer: 1, xp: 5 },
                { question: "Strategi Market Leader 'Protect Share' dilakukan dengan cara...", options: ["Inovasi berkelanjutan (Continuous Innovation)", "Menurunkan kualitas", "Menaikkan harga", "Mengurangi promosi"], answer: 0, xp: 5 },
                { question: "Dalam analisis pesaing, langkah 'Selecting' menyarankan untuk berhati-hati menghancurkan...", options: ["Pesaing Lemah", "Pesaing Dekat (Close Competitors)", "Pesaing Jauh", "Pesaing Asing"], answer: 1, xp: 5 },
                // MODUL 4: GLOBAL MARKETPLACE (15 questions)
                { question: "Strategi L'Oreal 'Universalisation' menggabungkan...", options: ["Cost Leadership & Focus", "Global Brand Impact & Local Brand Responsiveness", "Export & Import", "Online & Offline"], answer: 1, xp: 5 },
                { question: "Pajak impor yang dikenakan pemerintah disebut...", options: ["Quota", "Tariff", "Embargo", "Nontariff Barrier"], answer: 1, xp: 5 },
                { question: "Batasan jumlah barang yang boleh diimpor disebut...", options: ["Quota", "Tariff", "Exchange Control", "Tax"], answer: 0, xp: 5 },
                { question: "Struktur ekonomi negara kaya SDA tapi miskin industri (Pasar alat berat) adalah...", options: ["Subsistence Economies", "Raw Material Exporting Economies", "Emerging Economies", "Industrial Economies"], answer: 1, xp: 5 },
                { question: "Struktur ekonomi negara manufaktur tumbuh cepat & kelas menengah baru (BRIC) adalah...", options: ["Subsistence Economies", "Emerging Economies (Industrializing)", "Raw Material Exporting", "Industrial Economies"], answer: 1, xp: 5 },
                { question: "Strategi masuk pasar global risiko terendah (lewat perantara) adalah...", options: ["Direct Investment", "Joint Venture", "Direct Exporting", "Indirect Exporting"], answer: 3, xp: 5 },
                { question: "Menjual hak merek/resep dengan bayaran royalti (Contoh: Coca-Cola) adalah...", options: ["Licensing", "Contract Manufacturing", "Direct Investment", "Management Contracting"], answer: 0, xp: 5 },
                { question: "Mengontrak pabrik lokal untuk memproduksi barang (Risiko kecil, cepat mulai) adalah...", options: ["Licensing", "Contract Manufacturing", "Management Contracting", "Joint Ownership"], answer: 1, xp: 5 },
                { question: "Membangun fasilitas sendiri 100% di luar negeri (Risiko tertinggi, Kontrol penuh) adalah...", options: ["Direct Investment", "Joint Venture", "Exporting", "Licensing"], answer: 0, xp: 5 },
                { question: "Adaptasi: Mengubah produk, Promosi tetap. Disebut...", options: ["Straight Extension", "Product Adaptation", "Communication Adaptation", "Dual Adaptation"], answer: 1, xp: 5 },
                { question: "Adaptasi: Produk tetap, Promosi diubah. Disebut...", options: ["Straight Extension", "Product Adaptation", "Communication Adaptation", "Dual Adaptation"], answer: 2, xp: 5 },
                { question: "Adaptasi: Mengubah produk DAN promosi sekaligus. Disebut...", options: ["Straight Extension", "Product Adaptation", "Dual Adaptation", "Product Invention"], answer: 2, xp: 5 },
                { question: "Menciptakan produk baru khusus untuk pasar luar negeri disebut...", options: ["Product Invention", "Product Adaptation", "Dual Adaptation", "Straight Extension"], answer: 0, xp: 5 },
                { question: "Menjual produk di luar negeri lebih murah dari modal/domestik (Ilegal) disebut...", options: ["Price Escalation", "Dumping", "Transfer Pricing", "Discounting"], answer: 1, xp: 5 },
                { question: "Strategi Gojek di Vietnam/Thailand (Ganti nama & layanan) adalah contoh...", options: ["Standardized Marketing", "Adapted Marketing", "Global Marketing", "Export Marketing"], answer: 1, xp: 5 },
                { question: "Jenis Joint Venture 'Joint Ownership' berarti...", options: ["Membentuk PT baru bersama investor lokal", "Sekadar memberi lisensi", "Mengontrak pabrik", "Ekspor langsung"], answer: 0, xp: 5 },
                // MODUL 5: SUSTAINABLE MARKETING (14 questions)
                { question: "Tujuan Unilever Sustainable Living Plan adalah...", options: ["Profit maksimal tanpa peduli lingkungan", "Bisnis tumbuh 2x, Dampak lingkungan turun 50%, Dampak sosial naik", "Menutup pabrik yang polusi", "Hanya fokus donasi"], answer: 1, xp: 5 },
                { question: "Definisi Sustainable Marketing adalah...", options: ["Memenuhi kebutuhan kini untuk profit kini", "Memenuhi kebutuhan kini sambil melestarikan kemampuan generasi masa depan", "Hanya memikirkan masa depan", "Menjual produk daur ulang saja"], answer: 1, xp: 5 },
                { question: "Penyebab kritik 'High Prices' menurut pengamat sosial, KECUALI...", options: ["Biaya Distribusi Tinggi", "Biaya Iklan/Promo Tinggi", "Markup Berlebihan", "Biaya Bahan Baku Murah"], answer: 3, xp: 5 },
                { question: "Praktik 'Deceptive Pricing' adalah...", options: ["Iklan berlebihan", "Menipu harga (diskon palsu/harga eceran palsu)", "Kemasan isi angin", "Produk cepat rusak"], answer: 1, xp: 5 },
                { question: "Praktik 'Deceptive Packaging' (Slack Filling) adalah...", options: ["Harga palsu", "Kemasan dibuat besar tapi isinya sedikit", "Iklan bohong", "Barang palsu"], answer: 1, xp: 5 },
                { question: "Sengaja membuat produk cepat rusak/usang (Planned Obsolescence) sering terjadi di industri...", options: ["Makanan", "Fashion & Gadget", "Properti", "Jasa"], answer: 1, xp: 5 },
                { question: "Diskriminasi wilayah (menghindari buka toko di daerah miskin) disebut...", options: ["Greenwashing", "Redlining", "Whitewashing", "Blacklisting"], answer: 1, xp: 5 },
                { question: "Gerakan hak pembeli (Tahu, Didengar, Aman, Memilih) disebut...", options: ["Consumerism", "Environmentalism", "Socialism", "Capitalism"], answer: 0, xp: 5 },
                { question: "Strategi lingkungan: Mencegah limbah sebelum diciptakan (Internal/Hari Ini) adalah...", options: ["Pollution Prevention", "Product Stewardship", "New Clean Technology", "Sustainability Vision"], answer: 0, xp: 5 },
                { question: "Strategi lingkungan: Tanggung jawab dampak produk sepanjang siklus hidup (Eksternal/Hari Ini) adalah...", options: ["Pollution Prevention", "Product Stewardship", "New Clean Technology", "Sustainability Vision"], answer: 1, xp: 5 },
                { question: "Prinsip: Perusahaan mendefinisikan misi dalam istilah sosial luas (Sense-of-Mission) contohnya...", options: ["Dove membangun kepercayaan diri wanita", "Perusahaan jual sabun biasa", "Perusahaan cari untung", "Perusahaan teknologi"], answer: 0, xp: 5 },
                { question: "Kasus Lemonilo menerapkan Societal Marketing dengan menyeimbangkan...", options: ["Konsumen (Enak), Company (Profit), Society (Sehat)", "Harga, Barang, Tempat", "Lokal, Nasional, Global", "Iklan, Sales, PR"], answer: 0, xp: 5 },
                { question: "Kritik 'Cultural Pollution' menuduh pemasaran...", options: ["Mencemari udara", "Mengotori indera masyarakat dengan gangguan komersial/iklan berlebih", "Merusak budaya tradisional", "Membuang limbah sembarangan"], answer: 1, xp: 5 },
                // ADDENDUM (5 questions)
                { question: "Hambatan perdagangan 'Nontariff Barriers' meliputi...", options: ["Pajak impor", "Batasan jumlah", "Standar produk yang bias atau birokrasi dipersulit", "Larangan total"], answer: 2, xp: 5 },
                { question: "Peran baru pemasar 'Content Marketing Manager' bertugas...", options: ["Hanya membuat iklan TV", "Menciptakan, Menginspirasi, dan Membagikan pesan merek (Shareable)", "Mengurus logistik", "Mengatur keuangan"], answer: 1, xp: 5 },
                { question: "Tujuan 'Benchmarking' dalam analisis pesaing adalah...", options: ["Meniru pesaing persis", "Membandingkan produk/proses dengan pesaing/pemimpin untuk perbaikan", "Mencuri rahasia dagang", "Menurunkan harga"], answer: 1, xp: 5 },
                { question: "Strategi lingkungan 'New Clean Technology' fokus pada...", options: ["Pencegahan limbah saat ini", "Mengembangkan kemampuan baru untuk masa depan (Internal)", "Tanggung jawab produk", "Visi strategis"], answer: 1, xp: 5 },
                { question: "Kenaikan harga produk di luar negeri akibat logistik & tarif disebut...", options: ["Price Escalation", "Dumping", "Inflation", "Devaluation"], answer: 0, xp: 5 },
