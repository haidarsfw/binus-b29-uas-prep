    ...
    content: {
        ...
        intro: {
            ...
            flashcards: [
                ...
                { id: 1, term: 'Pemimpin (Leader)', definition: 'Individu yang memiliki kemampuan untuk memengaruhi orang lain dan memegang otoritas manajerial' },
                { id: 2, term: 'Kepemimpinan (Leadership)', definition: 'Proses memengaruhi sekelompok orang untuk mencapai tujuan bersama' },
                { id: 3, term: 'Trait Theories', definition: 'Teori yang berfokus pada identifikasi karakteristik fisik atau kepribadian yang membedakan pemimpin dari bukan pemimpin (era 1920-1930an)' },
                { id: 4, term: 'Gaya Autokratis', definition: 'Pemimpin memusatkan wewenang, mendikte metode kerja, dan membatasi partisipasi bawahan' },
                { id: 5, term: 'Gaya Demokratis', definition: 'Pemimpin melibatkan karyawan dalam pengambilan keputusan dan mendelegasikan wewenang. Menghasilkan kepuasan kerja lebih tinggi' },
                { id: 6, term: 'Gaya Laissez-faire', definition: 'Pemimpin memberikan kebebasan total kepada kelompok untuk membuat keputusan. Seringkali tidak efektif karena kurangnya arahan' },
                { id: 7, term: 'Initiating Structure', definition: 'Sejauh mana pemimpin mendefinisikan peran, menetapkan target, dan mengorganisir pekerjaan' },
                { id: 8, term: 'Consideration', definition: 'Sejauh mana pemimpin membangun hubungan kerja berdasarkan kepercayaan timbal balik dan menghargai perasaan bawahan' },
                { id: 9, term: 'Situational Leadership (SLT)', definition: 'Teori Hersey & Blanchard: kepemimpinan efektif bergantung pada Kesiapan (Readiness) pengikut' },
                { id: 10, term: 'R1 - Telling', definition: 'Pengikut Tidak Mampu & Tidak Mau → Pemimpin memberikan instruksi spesifik dan pengawasan ketat' },
                { id: 11, term: 'R2 - Selling', definition: 'Pengikut Tidak Mampu tapi Mau → Pemimpin menjelaskan keputusan dan memberikan kesempatan bertanya' },
                { id: 12, term: 'R3 - Participating', definition: 'Pengikut Mampu tapi Tidak Mau/Ragu → Pemimpin berbagi ide dan memfasilitasi pengambilan keputusan' },
                { id: 13, term: 'R4 - Delegating', definition: 'Pengikut Mampu & Mau → Pemimpin menyerahkan tanggung jawab keputusan sepenuhnya' },
                { id: 14, term: 'Path-Goal Theory', definition: 'Tugas pemimpin adalah membantu pengikut mencapai tujuan. Pemimpin sebagai "pembuka jalan"' },
                { id: 15, term: 'In-Group (LMX)', definition: 'Kelompok yang dipercaya pemimpin, mendapat perhatian lebih, dan sering mendapat tugas istimewa' },
                { id: 16, term: 'Out-Group (LMX)', definition: 'Kelompok yang hanya menjalankan tugas formal dengan hubungan terbatas dengan pemimpin' },
                { id: 17, term: 'Legitimate Power', definition: 'Kekuasaan yang berasal dari posisi formal dalam hierarki organisasi' },
                { id: 18, term: 'Coercive Power', definition: 'Kekuasaan berdasarkan rasa takut atau kemampuan menghukum (memecat, menunda promosi)' },
                { id: 19, term: 'Reward Power', definition: 'Kekuasaan untuk memberikan penghargaan atau insentif yang bernilai bagi orang lain' },
                { id: 20, term: 'Expert Power', definition: 'Kekuasaan berdasarkan keahlian, keterampilan khusus, atau pengetahuan mendalam' },
                { id: 21, term: 'Referent Power', definition: 'Kekuasaan karena orang lain mengagumi atau ingin meniru karakteristik pribadi pemimpin (karisma)' },
                { id: 22, term: '5 Dimensi Kepercayaan', definition: 'Integritas, Kompetensi, Konsistensi, Loyalitas, Keterbukaan' },
                ...
                { id: 50, term: '3 Strategi Politik Kantor', definition: 'Networking, Hindari Tainted Members, Support Your Boss' },
                { id: 51, term: 'Hierarki Maslow', definition: '5 tingkat: Fisiologis → Keamanan → Sosial → Penghargaan → Aktualisasi Diri' },
                { id: 52, term: 'Teori Herzberg', definition: 'Hygiene (gaji) = cegah ketidakpuasan. Motivator (prestasi) = tingkatkan kepuasan' },
                { id: 53, term: 'Equity Theory', definition: 'Karyawan bandingkan Input:Output diri vs orang lain. Ketidakadilan = malas/resign' },
                { id: 54, term: 'Expectancy Theory', definition: '3 keyakinan: Expectancy → Instrumentality → Valence' },
                ...
                { id: 59, term: '6 Langkah Strategis', definition: 'Identifikasi Misi → Analisis Eksternal → Analisis Internal → Rumus Strategi → Implementasi → Evaluasi' },
